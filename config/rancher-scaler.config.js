const config = {
  ...
  nodes: [
    ...
    //               wget https://raw.githubusercontent.com/mojaloop/rancher-scaler/master/config/_install_cloudwatch.sh?token=AAM3EDHBMSVJADMWLCSXALS67KU4O -O /tmp/_install_cloudwatch.sh;
